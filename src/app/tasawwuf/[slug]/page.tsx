...
export default function TasawwufDetailPage({
  params,
}: {
    ...
    async function fetchPost() {
      try {
        ...
        const res = await fetch(
          `https://lawngreen-dragonfly-304220.hostingersite.com/api/tasawwuf/${resolvedParams.slug}`
        );
  ...
  return (
    ...
    >
      ...
      <nav className="text-sm text-gray-500">
        ...
        /
        <a href="/tasawwuf" className="text-orange-500 hover:text-gray-600">
          {" "}
          Tasawwuf
        </a>{" "}
        /
