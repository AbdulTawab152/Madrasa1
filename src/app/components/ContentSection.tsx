  ...
  return (
    <div className="w-full">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-amber-50 to-orange-50 py-20 px-6 rounded-3xl mb-16 shadow-2xl border border-amber-100">
        ...
        <div className="absolute bottom-12 right-16 w-20 h-20 bg-gradient-to-br from-orange-300/30 to-amber-300/20 rounded-full blur-2xl animate-float-medium" style={{ animationDelay: "1.5s" }}></div>
        <div className="absolute top-1/3 right-1/4 w-16 h-16 bg-gradient-to-br from-amber-300/20 to-orange-200/10 rounded-full blur-xl animate-float-slow" style={{ animationDelay: "2.5s" }}></div>
        ...
        >
          ...
          >
            ...
            <div className="w-3 h-3 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full animate-ping-medium" style={{ animationDelay: "0.3s" }}></div>
            <div className="w-3 h-3 bg-gradient-to-br from-amber-500 to-amber-600 rounded-full animate-ping-slow" style={{ animationDelay: "0.6s" }}></div>
          </motion.div>
        </motion.div>
      </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                  <div className="flex-1">
                    ...
                    >
                      <Link href={item.type === 'article' ? `/articles/${item.id}` : `/iftah/${item.slug}`} className="hover:underline block">
                        {item.title}
                      </Link>
                    </motion.h3>
                      ...
                      {(item.author || item.mufti) && (
                        ...
                        >
                          ...
                          <span className="text-amber-700">
                            {item.author?.name || item.mufti?.name || item.shared_by || "Anonymous"}
                          </span>
                        </motion.div>
                      )}
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4 border-t border-amber-100">
                  ...
                  <motion.div whileHover={{ x: 5 }}>
                    ...
                    >
                      {item.type === 'article' ? 'Read Article' : 'Read Full Answer'}
      ...
      {displayContent.length === 0 && (
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">No content available yet</h3>
          <p className="text-gray-600 max-w-md mx-auto">We're preparing valuable content. Check back soon for new articles and Q&A.</p>
        </motion.div>
      )}
