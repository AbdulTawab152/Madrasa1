        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-10 p-4 bg-white rounded-2xl shadow-md">
          ...
          <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-full">
            <button
              ...
              className={`p-2 rounded-full transition-all ${viewMode === "grid" ? "bg-white shadow-md" : "text-gray-500"}`}
            >
              <Grid3X3 size={18} />
            </button>
            <button
              onClick={() => setViewMode("slider")}
              className={`p-2 rounded-full transition-all ${viewMode === "slider" ? "bg-white shadow-md" : "text-gray-500"}`}
            >
