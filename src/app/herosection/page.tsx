...
<div className="absolute top-1/4 mt-10 sm:top-1/3  left-4 sm:left-10 lg:left-40 max-w-[90%] sm:max-w-[600px] space-y-4 z-30">
  ...
  <div className="flex flex-wrap gap-4 mt-4">
    {/* Learn More */}
    <button className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-yellow-400 hover:to-orange-500 px-5 py-3 rounded-full text-sm sm:text-base md:text-base font-semibold flex items-center justify-center gap-2 shadow-lg hover:scale-105 transition-transform duration-300">
      Learn More <FaArrowRight />
    </button>

    {/* Courses */}
    <button className="border border-orange-400 bg-white/10 backdrop-blur-sm text-orange-300 px-10 py-1 rounded-full text-sm sm:text-base md:text-base font-semibold flex items-center justify-center gap-2 hover:bg-orange-500/25 hover:text-white hover:shadow-lg transition-all duration-300">
      View Courses
    </button>
  </div>
</div>
