          ...
          <div className="flex flex-wrap items-center gap-4 mb-8 text-sm text-gray-500">
            <div className="flex items-center">
              <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center mr-2">
                <span className="text-gray-600 font-medium text-base">{(blog.author || "A")[0]}</span>
              </div>
            ...
            <div className="flex items-center">
              ...
              <span>{new Date(blog.publishedAt || blog.date).toLocaleDateString()}</span>
            </div>
            <div className="h-5 w-px bg-gray-300"></div>
            {/* <div className="flex items-center">
          ...
          <div className="bg-white rounded-2xl p-6 mb-12 border border-gray-200 shadow-md">
            <div className="flex items-start">
              <div className="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center mr-5 shadow-sm">
                <span className="text-gray-700 font-bold text-2xl">{(blog.author || "A")[0]}</span>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-gray-900">About the Author</h3>
                <p className="text-gray-700 mt-2 leading-relaxed">{blog.author} is a passionate contributor to our blog, sharing insightful perspectives and deep expertise in their field. Their articles aim to inspire and inform our readers.</p>
